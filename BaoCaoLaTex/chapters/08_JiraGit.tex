...
\begin{itemize}
	...
	\item Sinh viên có thể đặt câu hỏi.
	\item Hệ thống trả lời bằng RAG.
	\item Hệ thống trả lời bằng Fine-Tuning.
	\item Sinh viên so sánh hai phương pháp.
	\item Quản trị viên quản lý tài liệu.
	\item Quản trị viên xem báo cáo.
	\item Quản trị viên theo dõi kết quả Benchmark.
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|p{6cm}|c|}
		...
		\hline
		Sprint 5 & Fine-Tuning mô hình & Hoàn thành\\
		\hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{images/github_commit3}
	\caption{Lịch sử Commit (tiếp theo)}
